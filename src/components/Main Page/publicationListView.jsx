...
function PublicationListView({ publication }) {
  ...
  return (
    <div 
      key={id} className="card ofertapp-publication-card"
      ...
      <div className="card-body">
        <div className = "row">
          <div className = "col-12 col-sm-4 ofertapp-pub-card-support">
            {
              (supports && supports.length > 0) ?
                ...
                supports[0].type === "IMAGE" ?
                  ...
                  // Image
                  <img className = "ofertapp-pub-card-support-media"
                    src = {mediaUrl + supports[0].data}
                    alt='Publication support'
                  />
                  :
                  // Video
                  <video className = "ofertapp-pub-card-support-media"
                    controls
                    src = {mediaUrl + supports[0].data}
                  />
          ...
          <div className = "col-12 col-sm-8">
            <div className = "row">
              <div className = "col-12 ofertapp-pub-card-info-title">
                {title}
              </div>
              <div className = "col-12 col-sm-6 ofertapp-pub-card-info">
                Precio actual: COP $ {minOffer.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",")}
              </div>
              <div className = "col-12 col-sm-6 ofertapp-pub-card-info">
